...
bool RTKLocalizationComponent::Proc(
  ...
  if (localization_->IsServiceStarted()) {
    ...
    // DEBUG
    ADEBUG << "accel in localization module: " << localization.pose().linear_acceleration().x();
    ADEBUG << "accel in localization module: " << localization.pose().linear_acceleration().y();
    ADEBUG << "accel in localization module: " << localization.pose().linear_acceleration().z();
